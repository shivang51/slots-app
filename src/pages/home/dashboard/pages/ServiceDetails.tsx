...
import StarRating from "@pages/home/dashboard/components/StarRating";
import Packages from "@pages/home/dashboard/components/Packages";
      ...
      <View style={styles.content}>
        ...
        <Animatable.View animation={"fadeInUp"} duration={500}>
          ...
          >
            ...
            <IconButton.Secondary icon={"chat-bubble"} label={"Chat"} />
          ...
          />
          <Text style={{ marginTop: 8, fontSize: 20, padding: 8 }}>
            Reviews
          </Text>
          <Text
